...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column('group_id', sa.Integer, sa.ForeignKey("analysis_groups.id", ondelete='CASCADE')),
        sa.Column('clinic_id', sa.Integer, sa.ForeignKey("clinics.id", ondelete='CASCADE')),
